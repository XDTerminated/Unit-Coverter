...
main = tk.Label(window,text = 'Unit Converter',bg = '#ffdab9',fg = 'blue')
main['font'] = font1
main.place(relx = '0.48',rely = '0.1',anchor = 'center')

# Creating the unit label
unit = tk.Label(window,text = 'Unit -:',bg = '#ffdab9')
unit['font'] = font2
...
label_from = tk.Label(window,text = 'From -:',bg = '#ffdab9')
...
to = tk.Label(window,text = 'To -:',bg = '#ffdab9')
to['font'] = font2
...
art = tk.Label(window,text = 'The Art Of Programming',bg= '#ffdab9',fg = 'blue')
art['font'] = font3
